...
Before(async function () {
  ...
  const chairNotTakenSelector =
    ".buying-scheme__chair_standart:not(.buying-scheme__chair_taken)"; //стандартный не выбраный стул
  const chairVipNotTakenSelector =
    ".buying-scheme__chair_vip:not(.buying-scheme__chair_taken)"; //стандартный не выбраный стул
...
When("Случайный выбор стандартного места", async function () {
  ...
  ); //Cлучайное свободное стандартное место (занятые (chair_takend) исключены)
...
When("Случайный выбор VIP места", async function () {
  ...
  ); //Cлучайное свободное VIP место (занятые (chair_takend) исключены)
